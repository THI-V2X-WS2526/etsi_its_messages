...
#ifndef	_asn_PositionOfPillars_H_
#define	_asn_PositionOfPillars_H_
...
/* asn_PositionOfPillars */
typedef struct asn_PositionOfPillars {
	A_SEQUENCE_OF(asn_PosPillar_t) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} asn_PositionOfPillars_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_asn_PositionOfPillars;

#ifdef __cplusplus
}
#endif

#endif	/* _asn_PositionOfPillars_H_ */
