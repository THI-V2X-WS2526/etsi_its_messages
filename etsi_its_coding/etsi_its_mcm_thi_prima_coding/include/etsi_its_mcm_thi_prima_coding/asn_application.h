...
#include "etsi_its_mcm_thi_prima_coding/asn_system.h"		/* for platform-dependent types */
#include "etsi_its_mcm_thi_prima_coding/asn_codecs.h"		/* for ASN.1 codecs specifics */
#include "etsi_its_mcm_thi_prima_coding/asn_config.h"
...
#include "etsi_its_mcm_thi_prima_coding/constr_TYPE.h"	/* for asn_TYPE_descriptor_t */
