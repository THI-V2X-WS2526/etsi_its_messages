...
#include <etsi_its_mcm_thi_prima_coding/ber_tlv_length.h>
#include <etsi_its_mcm_thi_prima_coding/ber_tlv_tag.h>
...
#include <etsi_its_mcm_thi_prima_coding/per_decoder.h>  /* Packet Encoding Rules decoder */
#include <etsi_its_mcm_thi_prima_coding/per_encoder.h>  /* Packet Encoding Rules encoder */
#else
typedef void (per_type_decoder_f)(void);
typedef void (per_type_encoder_f)(void);
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */

#include <etsi_its_mcm_thi_prima_coding/constraints.h>  /* Subtype constraints support */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
#include <etsi_its_mcm_thi_prima_coding/asn_random_fill.h>  /* Random structures support */
#else
